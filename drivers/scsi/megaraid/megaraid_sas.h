 ...
 */
#define MEGASAS_VERSION				"06.603.04.00"
#define MEGASAS_RELDATE				"Dec. 17, 2013"
#define MEGASAS_EXT_VERSION			"Dec. 17 17:00:00 PDT 2013"
...
struct megasas_ctrl_info {
	...
	*/
	...
	u8  reserved6[4];                       //0x7E4 reserve for iov

        struct {                                //0x7E8
	#if defined(__BIG_ENDIAN_BITFIELD)
                u32     reserved                    :25;
                u32     supportCrashDump            :1;	/* FW supports Crash dump feature */
                u32     reserved1                   :6; 
        #else
                u32     reserved1                   :6;
        ...
        u8          pad[0x800-0x7EC]; 		//0x7E8 // pad to 2K for expansion	
} __packed;
...
MR_BuildRaidContext(struct megasas_instance *instance,
		    ...
		    MR_FW_RAID_MAP_ALL *map, u8 **raidLUN);
u8 MR_TargetIdToLdGet(u32 ldTgtId, MR_FW_RAID_MAP_ALL *map);
MR_LD_RAID *MR_LdRaidGet(u32 ld, MR_FW_RAID_MAP_ALL *map);
u16 MR_ArPdGet(u32 ar, u32 arm, MR_FW_RAID_MAP_ALL *map);
u16 MR_LdSpanArrayGet(u32 ld, u32 span, MR_FW_RAID_MAP_ALL *map);
u16 MR_PdDevHandleGet(u32 pd, MR_FW_RAID_MAP_ALL *map);
