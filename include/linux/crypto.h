 ...
 */
#define CRYPTO_ALG_TYPE_MASK		0x0000001f
...
#define CRYPTO_ALG_TYPE_PKC_DSA		0x00000007
#define CRYPTO_ALG_TYPE_PKC_RSA		0x00000009
#define CRYPTO_ALG_TYPE_PKC_DH		0x00000010
...
{
	return &crypto_pkc_tfm(tfm)->crt_u.pkc;
}
